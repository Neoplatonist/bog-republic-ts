...
/**
 * Renders the FirebaseUI widget.
 *
 * @export
 * @param {Props} { uiConfig, uiCallback, firebaseAuth, className }
 * @returns
 */
const StyledFirebaseAuth = ({ uiConfig, uiCallback, firebaseAuth, className }: Props) => {
