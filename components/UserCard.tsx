...
function UserCard() {
  ...
  if (
    typeof mycelium === 'undefined' ||
    typeof myceliumNotation === 'undefined'
  ) {
    console.log({ mycelium, myceliumNotation });
    return (
      <div className="flex min-h-screen items-center justify-center">
        <div className="rounded-lg bg-red-50 p-4 text-red-800">
          <h3 className="font-semibold">No Mycelium available</h3>
  ...
  return (
    <div
      className="flex justify-center items-center sticky top-0 z-10 mb-4 p-4 bg-secondary shadow-custom"
      style={{
        filter:
    ...
    >
      ...
      <div className="flex flex-col flex-1 justify-between content-between">
        ...
        <Link href="#user-rank" legacyBehavior>
          <a
            className="w-[100px] ms-0 me-0 pt-1 text-sm text-center underline underline-offset-[0.25em] decoration-neutral cursor-pointer hover:text-black hover:decoration-black hover:font-normal"
      ...
      <div className="flex flex-col basis-full" style={{ flex: '2' }}>
        {/* User Mycelium */}
        <div
          className="flex flex-col h-[100px] px-4 py-2 justify-center bg-success"
          style={{
        ...
        >
          <p className="p-0 ms-0 me-0 text-base text-center leading-5 font-semibold">
            ...
            <span className="text-2xl font-semibold">
              {mycelium.toFixed(2)}e{myceliumNotation}
            </span>
          </p>
